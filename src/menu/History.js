                            ...
                            <div class="row">
                                ...
                                <div class="col-5 d-flex align-items-center">
                                    <div class="d-flex flex-column justify-content-end">
                                        <button class="btn bg-main text-white text-xs rounded-small"> Tarik saldo</button>
                                    </div>
                                </div>
                            </div> 
                        </div>
                ...
                <div className="col-12">
                    <div className="col-12 py-2">
                        <div className="row">
                            ...
                            <div className="bg-slate-200 border-icon-saldo d-flex justify-content-center align-items-center rounded-03"><span className={`icon-saldo ${item.imgclass}`}></span></div>
